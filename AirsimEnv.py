...
class AirsimEnv(gym.Env):
   ...
   # instaura una connessione con il simulatore
    ...
    def _init_reward_points(self):
        road_points = []
        with open('C:/Users/valen/Desktop/magistrale/tesi/csp-drive-rl-master/AirsimEnv/final_reward_points.csv', newline="") as csvfile:
    ...
    def is_done(self, car_state, info_collision, out_street):
        ...
        return 1 if info_collision.has_collided or out_street or car_state.speed < 1 else 0
