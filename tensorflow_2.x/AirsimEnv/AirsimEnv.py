...
class AirsimEnv(gym.Env):
   ...
   # instaura una connessione con il simulatore
    ...
    def _init_reward_points(self):
        road_points = []
        with open('C:/Users/valen/Desktop/magistrale/tesi_2/csp-drive-rl-master/AirsimEnv/final_reward_points.csv', newline="") as csvfile:
    ...
    def _animals_out(self, neighbourhood=False):

        if neighbourhood:
            animals = ["RaccoonBP2_85", "RaccoonBP3_154", "RaccoonBP4_187", "RaccoonBP_50", "DeerBothBP2_19","DeerBothBP3_43", "DeerBothBP4_108", "DeerBothBP5_223", "DeerBothBP_12"]
        else:
            animals = []
    ...
    def is_done(self, car_state, info_collision, out_street):
        ...
        return 1 if info_collision.has_collided or out_street or car_state.speed < 3 else 0

#or car_state.speed < 1